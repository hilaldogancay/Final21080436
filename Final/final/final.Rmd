...
library(tidyverse)
library(here)
survey <- read.csv(here("../data/Baseline_characteristics_Binding_Antibody_data_anon.csv"))
mydata <- read_csv("Baseline_characteristics_Binding_Antibody_data_anon.csv")
